...
public class ConsumerProductController {
    public static final String PRODUCT_GET_URL = "http://CCIP-PRODUCT-SLEUTH/product/get/";
    public static final String PRODUCT_LIST_URL="http://CCIP-PRODUCT-SLEUTH/product/list/";
    public static final String PRODUCT_ADD_URL = "http://CCIP-PRODUCT-SLEUTH/product/add/";
    @Resource
